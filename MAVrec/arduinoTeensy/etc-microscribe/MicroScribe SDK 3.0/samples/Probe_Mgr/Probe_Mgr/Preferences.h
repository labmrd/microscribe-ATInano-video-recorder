/*/////////////////////////////////////////////////////////////////////////
  ...
  FILE:		Preferences.h : Persistent data class definition.
...
public:
	...
	bool m_bOffsetTipFlag;
	float m_fOffsetTipLength;	// Stored in inches.
	bool m_bMetric;
};

// Providing general access to the user preferences object.
