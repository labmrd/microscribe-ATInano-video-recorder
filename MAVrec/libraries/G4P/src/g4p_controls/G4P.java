 ...
 * <em>They are provided as-is and have not been tested on all platforms. If they 
 * don't work for you then use those provided by Processing. </em><br>
 * 
 * 
 * @author Peter Lager
 *
...
public class G4P implements GConstants, PConstants {
	...
	static void announceG4P(){
		if(!announced){
			System.out.println("=======================================================");
			System.out.println("   G4P V4.3.6 created by Peter Lager");
			System.out.println("=======================================================");
			announced = true;
		}
	}
	...
	/**
	 * Determines how the direction of the mouse wheel rotation is interpreted
	 * for spinners. This value applies to all spinners. <br>
	 * The default value is FORWARD
	 * @param dir FORWARD or REVERSE, illegal values are ignored
	 */
	 ...
	 * G4P.PLAIN_MESSAGE, G4P.ERROR_MESSAGE, G4P.INFO_MESSAGE, G4P.WARN_MESSAGE, G4P.QUERY_MESSAGE <br>
	 * 
