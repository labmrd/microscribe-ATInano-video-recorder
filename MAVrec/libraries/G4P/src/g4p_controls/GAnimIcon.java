...
public class GAnimIcon extends GIcon {
	...
	/**
	 * @return returns this animated icon.
	 */
	@Override
	public GAnimIcon getThis() {
		return this;
	}
	 ...
	 * @param title title for this list
	 */
	public void listClips(String title) {
		System.out.println("-----------------------------------------------------------------");
		System.out.println(title);
		for(String key : clips.keySet()){
			System.out.println(clips.get(key));
		}
		System.out.println("-----------------------------------------------------------------");
	}
