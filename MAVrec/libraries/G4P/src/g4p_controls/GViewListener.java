 ...
 * and override the update() method and any of the mouse???() methods
 * they want to use.
 * 
 * @author Peter Lager
 *
...
public class GViewListener implements PConstants {
	...
	protected GAbstractView gview = null;
	...
	protected float wheel_sensitivity = 1;
	 ...
	 */
	protected void setView(GAbstractView view) {
		gview = view;
	}
	 ...
	 */
	final public float wheelSensitivity() {
		return wheel_sensitivity;
	}
	
	/**
	 * Set the mouse wheel sensitivity for this listener
	 * @param sensitivity the wheel sensitivity to use
	 */
	final public void wheelSensitivity(float sensitivity) {
		wheel_sensitivity = sensitivity;
	}
	
	/**
	 * Get the raw count value returned by the mouse wheel. <br>
	 * You would need to scale this for your mouse by multiplying by 
