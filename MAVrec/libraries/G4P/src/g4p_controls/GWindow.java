...
public abstract class GWindow extends PApplet implements GConstants, GConstantsInternal {
	...
	public abstract boolean usesGL();
	...
	*/
	 ...
	 */
	public abstract void setAlwaysOnTop(boolean ontop);
	 ...
	 */
	public void close(){
		if(actionOnClose == KEEP_OPEN || actionOnClose == HIDE_WINDOW || actionOnClose == EXIT_APP ) return;
	...
	public void forceClose(){
		...
		if(actionOnClose == KEEP_OPEN || actionOnClose == HIDE_WINDOW)
	...
	public void setup(){
		...
		initListeners();			// Initialise listeners
	}
